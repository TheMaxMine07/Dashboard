  ...
  const [dashboards] = useState<Dashboard[]>([
    {
      ...
      description:
        "View website traffic, user behavior, and performance metrics",
    ...
    },
    {
      ...
      description:
        "Security logs, threat detection, and vulnerability scanning",
                ...
                <div className="hidden md:flex items-center space-x-4 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-success font-medium">
                      {systemInfo.onlineServers}
                    </span>
                    <span className="text-muted-foreground">/</span>
                    <span className="text-foreground">
                      {systemInfo.totalServers}
                    </span>
                  </div>
          ...
          {!error && (
            <div className="mb-4 p-4 bg-info/10 border border-info/20 rounded-lg">
              <p className="text-info text-sm">
                <strong>TMMNets Live Dashboard:</strong> Showing real-time
                status of your server infrastructure. Data refreshes
                      ...
                      <CardTitle className="flex items-center justify-between text-base">
                        ...
                        <div className="flex items-center space-x-2">
                          {server.status === "online" ? (
                            <Wifi
                              className={`h-4 w-4 ${getStatusColor(server.status)}`}
                            />
                          ) : (
                            <WifiOff
                              className={`h-4 w-4 ${getStatusColor(server.status)}`}
